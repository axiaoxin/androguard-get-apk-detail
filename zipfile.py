...
def _EndRecData(fpin):
    ...
    if start >= 0:
        ...
        comment = data[start + sizeEndCentDir: start + sizeEndCentDir + commentSize]  # flake8: noqa
...
class ZipInfo(object):
    ...
    def FileHeader(self):
        ...
        header = struct.pack(
            structFileHeader, stringFileHeader, self.extract_version,
            self.reserved, flag_bits, self.compress_type, dostime, dosdate, CRC,
    ...
    def close(self):
        ...
        if self.mode in ("w", "a") and self._didModify:  # write ending records
            ...
            if (centDirCount >= ZIP_FILECOUNT_LIMIT or
                centDirOffset > ZIP64_LIMIT or centDirSize > ZIP64_LIMIT):
                # Need to write the ZIP64 end-of-archive records
                zip64endrec = struct.pack(structEndArchive64,
                                          stringEndArchive64, 44, 45, 45, 0, 0,
                                          centDirCount, centDirCount,
